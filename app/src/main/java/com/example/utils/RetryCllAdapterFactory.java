...
public class RetryCllAdapterFactory extends CallAdapter.Factory {
    private static final String TAG = "RetryCallAdapterFactory";

    Context context;

    public RetryCllAdapterFactory(Context context) {
        this.context = context;
    }

    public static RetryCllAdapterFactory create(Context context) {
        return new RetryCllAdapterFactory(context);
    }
